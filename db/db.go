...
func (m *InMem) Lock(c context.Context,
	id *url.URL) error {
...
func (m *InMem) Unlock(c context.Context,
	id *url.URL) error {
...
func (m *InMem) Owns(c context.Context,
...
func (m *InMem) Exists(c context.Context,
...
func (m *InMem) Get(c context.Context,
...
func (m *InMem) Create(c context.Context,
...
func (m *InMem) Update(c context.Context,
	asType vocab.Type) error {
...
func (m *InMem) Delete(c context.Context,
	id *url.URL) error {
...
func (m *InMem) InboxContains(c context.Context,
	inbox,
...
func (m *InMem) GetInbox(c context.Context,
...
func (m *InMem) SetInbox(c context.Context,
...
func (m *InMem) GetOutbox(c context.Context,
	inboxIRI *url.URL) (inbox vocab.ActivityStreamsOrderedCollectionPage, err error) {
	// Similar to `GetInbox`, but for the outbox. See `GetInbox`.
}

func (m *InMem) SetOutbox(c context.Context,
	inbox vocab.ActivityStreamsOrderedCollectionPage) error {
	// Similar to `SetInbox`, but for the outbox. See `SetInbox`.
}

func (m *InMem) ActorForOutbox(c context.Context,
...
func (m *InMem) ActorForInbox(c context.Context,
...
func (m *InMem) OutboxForInbox(c context.Context,
...
func (m *InMem) NewID(c context.Context,
...
func (m *InMem) Followers(c context.Context,
...
func (m *InMem) Following(c context.Context,
	actorIRI *url.URL) (followers vocab.ActivityStreamsCollection, err error) {
...
func (m *InMem) Liked(c context.Context,
	actorIRI *url.URL) (followers vocab.ActivityStreamsCollection, err error) {
